  ...
  <body>
    ...
    <section class="ftco-section ftco-pricing">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4">Our Products and Service  Prices</h2>
            <p>Every innovative beauty tool, texture, formula, and cosmetic colour makes your life easier, more
fun, and uniquely beautiful</p>
          </div>
        </div>
            <table class="table table-bordered"> <thead> <tr> <th>#</th> <th>Service /Products Name</th> <th>Service / Product Price</th> </tr> </thead> <tbody>
<?php
