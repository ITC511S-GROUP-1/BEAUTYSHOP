	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Beauty Products</span>
			            <h1 class="mb-4">Get Pretty Look</h1>
			            <p class="mb-4">Our drive to better your beauty routine sets the foundation for every Ayesha Beauty creation, a
...
knowledge shared over generations amongst Namibian matriarchs</p>
